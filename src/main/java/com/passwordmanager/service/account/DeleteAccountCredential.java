...
public class DeleteAccountCredential {
	...
	// This method deletes an account credential after verifying the user's master
	// password
	public static void deleteCredential(int userId) {
		...
		String encryptedPassword = com.passwordmanager.util.SimpleCipherUtil.encrypt(masterPassword);
