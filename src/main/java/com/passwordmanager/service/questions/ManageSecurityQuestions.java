...
public class ManageSecurityQuestions {
    ...
    private static final SecurityQuestionDao questionDao =
            new SecurityQuestionDaoImp();
    private static final SecurityAnswerDao answerDao =
            new SecurityAnswerDaoImp();
    private static final UserInfoDao userDao =
            new UserInfoDaoImp();
    ...
    public static void manage(int userId) {
        ...
        while (true) {
            ...
            System.out.println(
                    "1. View security question and answer");
            System.out.println(
                    "2. Update existing question answers");
            System.out.println(
                    "3. Replace a question with a new question");
            System.out.println(
                    "0. Back to User Menu");
            System.out.print(
                    "Enter your choice: ");
    ...
    private static void viewSecurityQuestions(int userId) {
        ...
        if (!userDao
                .verifyLoginByUserIdAndPassword(
                        userId,
                        masterPassword)) {
    ...
    private static void replaceSecurityQuestion(int userId) {
        ...
        System.out.print(
                "Enter the question id to replace: ");
        ...
        System.out.print(
                "Enter answer for the new question: ");
