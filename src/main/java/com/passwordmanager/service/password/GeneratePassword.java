...
public class GeneratePassword {
	...
	public static String generatePassword(int length, boolean useUpper, boolean useLower, boolean useDigits,
			boolean useSymbols) {
	...
	public static void generatePasswordConsole() {
		...
		try {
			...
			System.out.println("Use Uppercase Letters? (y/n):");
			upper = scan.nextLine().equalsIgnoreCase("y");

			System.out.println("Use Lowercase Letters? (y/n):");
			lower = scan.nextLine().equalsIgnoreCase("y");

			System.out.println("Use Digits? (y/n):");
			digits = scan.nextLine().equalsIgnoreCase("y");

			System.out.println("Use Symbols? (y/n):");
			symbols = scan.nextLine().equalsIgnoreCase("y");
		...
		if (password != null) {
			...
			System.out.println("No character type selected. Password not generated.");
		}
	}
}
